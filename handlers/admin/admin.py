...
async def admin_panel(message: Message, state: FSMContext):
    """
    Обработчик команды «🛡️ Панель администратора».
    ...
    :param message: (Message) Входящее сообщение с командой «🛡️ Панель администратора».
    ...
    try:
        ...
        await message.answer(
            text=(
                "👋 <b>Добро пожаловать в 🛡️ Панель администратора!</b>\n\n"
...
def register_handlers_admin_panel():
    """
    Регистрирует обработчик команды «🛡️ Панель администратора» в маршрутизаторе.

    Добавляет в router обработчик для команды, активируемой по тексту «🛡️ Панель администратора».
